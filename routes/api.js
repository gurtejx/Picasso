...
router.get("/script", async (req, res) => {
  ...
  res.json({title: "Exploring Vancouver: Top Places to Visit", content: [
    {sentence: "Welcome to Vancouver, a vibrant city in British Columbia, Canada.", image_search_keyword: "Vancouver skyline"},
    {sentence: "Start your journey by visiting Stanley Park, a lush urban oasis with stunning views.", image_search_keyword: "Stanley Park Vancouver"},
    {sentence: "Next, head to Granville Island Public Market, a bustling hub of art, food, and culture.", image_search_keyword: "Granville Island Public Market"},
    {sentence: "Don't miss out on exploring Gastown, known for its historic charm and stylish boutiques.", image_search_keyword: "Gastown Vancouver"},
    {sentence: "Cap off your day by strolling through the picturesque VanDusen Botanical Garden.", image_search_keyword: "VanDusen Botanical Garden"}
  ]})
